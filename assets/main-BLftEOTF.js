(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))s(e);new MutationObserver(e=>{for(const a of e)if(a.type==="childList")for(const c of a.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&s(c)}).observe(document,{childList:!0,subtree:!0});function i(e){const a={};return e.integrity&&(a.integrity=e.integrity),e.referrerPolicy&&(a.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?a.credentials="include":e.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function s(e){if(e.ep)return;e.ep=!0;const a=i(e);fetch(e.href,a)}})();(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const e of s)if(e.type==="childList")for(const a of e.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&i(a)}).observe(document,{childList:!0,subtree:!0});function t(s){const e={};return s.integrity&&(e.integrity=s.integrity),s.referrerPolicy&&(e.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?e.credentials="include":s.crossOrigin==="anonymous"?e.credentials="omit":e.credentials="same-origin",e}function i(s){if(s.ep)return;s.ep=!0;const e=t(s);fetch(s.href,e)}})();(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const e of s)if(e.type==="childList")for(const a of e.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&i(a)}).observe(document,{childList:!0,subtree:!0});function t(s){const e={};return s.integrity&&(e.integrity=s.integrity),s.referrerPolicy&&(e.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?e.credentials="include":s.crossOrigin==="anonymous"?e.credentials="omit":e.credentials="same-origin",e}function i(s){if(s.ep)return;s.ep=!0;const e=t(s);fetch(s.href,e)}})();const l="1.1.0",o=new Date().toISOString(),r="https://fulfillment-backend.up.railway.app";document.querySelector("#app").innerHTML=`
...
`;document.addEventListener("DOMContentLoaded",()=>{var n;document.querySelectorAll('a[href^="#"]').forEach(t=>{t.addEventListener("click",function(i){i.preventDefault();const s=document.querySelector(this.getAttribute("href"));s&&s.scrollIntoView({behavior:"smooth"})})}),document.querySelectorAll(".feature-card").forEach(t=>{t.addEventListener("mouseenter",()=>{t.style.transform="translateY(-5px)",t.style.boxShadow="0 10px 30px rgba(0,0,0,0.2)"}),t.addEventListener("mouseleave",()=>{t.style.transform="translateY(0)",t.style.boxShadow="0 4px 15px rgba(0,0,0,0.1)"})}),(n=document.getElementById("test-backend-btn"))==null||n.addEventListener("click",async()=>{const t=document.getElementById("test-backend-btn"),i=document.getElementById("api-test-result");t.disabled=!0,t.textContent="测试中...",i.style.display="block",i.innerHTML="<p>🔄 正在连接后端API...</p>";try{const s=await(await fetch(`${r}/health`)).json(),e=await(await fetch(`${r}/api/version`)).json();i.innerHTML=`
        <div class="api-success">
          ...
          <div class="api-details">
            ...
            <p><strong>后端地址：</strong><a href="${r}" target="_blank">${r}</a></p>
          </div>
        </div>
      `}catch(s){i.innerHTML=`
        <div class="api-error">
          ...
          <p><strong>预期地址：</strong>${r}</p>
          <p><em>请参考部署指南完成后端部署</em></p>
        </div>
      `}finally{t.disabled=!1,t.innerHTML='<span class="link-icon">🔧</span>测试后端API'}}),console.log("🎉 履约驱动酒店管理系统已启动！"),console.log("📊 当前版本:",l),console.log("🏗️ 架构: DDD + XState + RxDB"),console.log("🔗 后端API:",r)});
//# sourceMappingURL=main-BLftEOTF.js.map
